...
Of course, the resulting numeric vector `set3` will have  `1 2 3` as values! As a result, `set1` and `set3` are complements of each other from the whole vector `x`. 
