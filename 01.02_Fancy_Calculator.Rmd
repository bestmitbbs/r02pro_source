...
Before we get started, the first item we will cover is adding comments for codes. In R, you can add comments by using the hash character `#` at the start of a line, which will extends to the end of the physical line. In each line, anything after `#` are comments, which will be ignored by R. Let's see an example,
