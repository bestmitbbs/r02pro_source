...
By the value assigned to the `length.out` argument, you know that the length of `extend` is 9. You also know that `2 3 4 5 6 7 8` are the elements of `extend`. Next, let’s put `extend` in `seq_along()`.
