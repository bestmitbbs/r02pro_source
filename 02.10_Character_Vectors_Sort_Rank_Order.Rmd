...
2. Apply both `rank()` and `order()` to the character vector `exercise`. Explain how does the returned element `7` mean differently in two returned vectors. #麻烦帮忙看看这个题的题目清楚吗
