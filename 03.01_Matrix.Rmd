...
Just as updating values on sub-vectors (Section \@ref(update-vector)), we can use the same technique for updating values in sub-matrices. To avoid the original matrix being changed, we will modify the values on an copy of the original matrix.
