...
Although the console may work well for some quick calculations, you need to resort to panel 1 in Figure \@ref(fig:four) (known as the **Editor**) to save our work and run multiple lines of code at the same time.
