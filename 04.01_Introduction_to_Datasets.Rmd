...
We will first introduce a dataset `gm2007`, located in the R package **r02pro**, the companion package of this book. The `gm2007` dataset is created from the gapminder (https://www.gapminder.org/) website from a wide range of public health related topics. In particular, `gm2007` contains 466 observations and 18 healthcare variables collected in year 2007. Each observation (row) corresponds to a specific country, with columns representing features like mortality, health spending, and other demographic information. 

Let's begin by loading the **r02pro** and **tibble** packages since `gm2007` is in a tibble format. 
