...
When you print a vector with many than one elements, the same number of decimal places is printed for all elements. In this case, the `digits` parameter represents the **minimum** number of significant digits,  and that at least one element will be encoded with that minimum number. 
